    ...
    cv::InputOutputArray img, const Scalar &color, int thickness, int lineType, float value)
{
    ...
    for (int i = 0; i < numTicks; i++) {
        ...
        cv::drawLineStroked(img,
                            Point(startX, tickPosY),
                            Point(startX + 10, tickPosY),
                            cv::Scalar(255, 255, 255),
                            thickness,
                            lineType);
    ...
    for (int i = 0; i < numTicks - 1; i++) {
        ...
        cv::drawLineStroked(img,
                            Point(startX, smallTickPosY),
                            Point(startX + 5, smallTickPosY),
                            cv::Scalar(255, 255, 255),
                            thickness,
                            lineType);
    }
...
void ScaleVertical::drawScaleRotated(
    cv::InputOutputArray img, const Scalar &color, int thickness, int lineType, float value)
{
    int startX = 70;
    int startY = 136;
