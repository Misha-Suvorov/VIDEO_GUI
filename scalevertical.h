...
public:
    ...
    ScaleVertical()
        : baseElement(0.5)
        , countStepsForVerticalScale(4)
        , countStepsForHorizontalScale(4)
        , lineLengthForVerticalScale(20)
        , lineLengthForHorizontalScale(20)
    {}
    void setCountStepsForVerticalScale(int value)
    {
        if (value > 0)
            countStepsForVerticalScale = value;
    }
    ...
    void setLineLengthForVerticalScale(int value)
    {
        if (value > 0)
            lineLengthForVerticalScale = value;
    }
    ...
    void drawScale(cv::InputOutputArray img,
                   ...
                   int lineType,
                   float value);
    void drawScaleRotated(cv::InputOutputArray img,
                          const cv::Scalar &color,
                          int thickness,
                          int lineType,
                          float value);
