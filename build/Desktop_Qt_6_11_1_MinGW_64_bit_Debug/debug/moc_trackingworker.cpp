...
template <> constexpr inline auto TrackingWorker::qt_create_metaobjectdata<qt_meta_tag_ZN14TrackingWorkerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'setTrackingROI'
        QtMocHelpers::SlotData<void(const cv::Rect &)>(11, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 6, 7 },
        }}),
        // Slot 'stopProcessing'
...
void TrackingWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TrackingWorker::*)(float , float )>(_a, &TrackingWorker::anglesCalculated, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (TrackingWorker::*)(const cv::Rect & )>(_a, &TrackingWorker::roiUpdated, 1))
            return;
    }
}
