...
public:
    ...
    void setupUi(QDialog *BiasCalibration)
    {
        if (BiasCalibration->objectName().isEmpty())
            BiasCalibration->setObjectName("BiasCalibration");
...
"}"));
        ...
        formLayout->setWidget(0, QFormLayout::ItemRole::FieldRole, lineEditTime);
        ...
        lineEditOffset1->setObjectName("lineEditOffset1");
...
"}"));
        ...
        formLayout->setWidget(1, QFormLayout::ItemRole::FieldRole, lineEditOffset1);
        ...
        lineEditOffset2->setObjectName("lineEditOffset2");
...
"}"));
        ...
        formLayout->setWidget(2, QFormLayout::ItemRole::FieldRole, lineEditOffset2);
        ...
        lineEditBiasH->setObjectName("lineEditBiasH");
...
"}"));
        ...
        formLayout_2->setWidget(0, QFormLayout::ItemRole::FieldRole, lineEditBiasH);
        ...
        lineEditBiasV->setObjectName("lineEditBiasV");
...
"}"));
        ...
        formLayout_2->setWidget(1, QFormLayout::ItemRole::FieldRole, lineEditBiasV);
        ...
        setBiasButton->setObjectName("setBiasButton");
        ...
        lineEditBiasHVerify->setObjectName("lineEditBiasHVerify");
...
"}"));
        ...
        lineEditBiasVVerify->setObjectName("lineEditBiasVVerify");
